...
public class IntrebareFile extends AbstractFileRepository<Integer, Intrebare> {
    ...
    public Intrebare extractEntity(List<String> attributes) {
        Intrebare intrebare = new Intrebare(Integer.parseInt(attributes.get(0)), attributes.get(1), attributes.get(2), attributes.get(3), attributes.get(4), attributes.get(5), Double.parseDouble(attributes.get(6)));
    ...
    protected String createEntityAsString(Intrebare entity) {
        return entity.getNrIntrebare() + ";" + entity.getDescriere() + ";" + entity.getV1()+ ";"+entity.getV2() + ";" + entity.getV3() + ";" +entity.getRaspunsCorect() + ";"+ entity.getPunctaj();
    }
}
