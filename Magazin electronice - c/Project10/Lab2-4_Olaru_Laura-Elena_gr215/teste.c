...
void testService()
{
	...
	Produs altProdus = creeazaProdus(55, "laptop", "Apple", "Macbook Pro", 2000, 5);
	Produs incaUnProdus = creeazaProdus(22, "mouse", "Asus", "III", 20, 2);


	//printf("\n%d\n", addServiceProdus(&serviceProdus, 22, "laptop", "Apple", "Macbook Pro", 2000, 1));
	//return;
